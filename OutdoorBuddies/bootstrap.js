...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.cmd": "../../../../../C:/Users/Shri/bin/Sencha/Cmd/6.0.2.14/plugins/src",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "OutdoorBuddies.controller.HomeController": [],
  "OutdoorBuddies.controller.LoginController": [],
  "OutdoorBuddies.controller.RegisterController": [],
  "OutdoorBuddies.controller.ScheduleGameController": [],
  "OutdoorBuddies.model.EventList": [],
  "OutdoorBuddies.model.User": [],
  "OutdoorBuddies.store.EventListStore": [],
  "OutdoorBuddies.store.User": [],
  "OutdoorBuddies.view.HomeView": [],
  "OutdoorBuddies.view.LoginView": [],
  "OutdoorBuddies.view.MapView": [],
  "OutdoorBuddies.view.RegisterView": [],
  "OutdoorBuddies.view.ScheduleGameView": [],
  "OutdoorBuddies.view.ScheduledEventListView": [],
  "OutdoorBuddies.view.TabView": [],
  "OutdoorBuddies.view.UserInfoView": []
});
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "OutdoorBuddies.view.ScheduleGameView": [
    "widget.schedulegameview"
  ],
  "OutdoorBuddies.view.ScheduledEventListView": [
    "widget.scheduledeventlistview"
  ],
  "OutdoorBuddies.view.TabView": [
    "widget.tabview"
  ],
